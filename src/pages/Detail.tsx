...
import { Loader2, ArrowLeft, Star, Heart, Play, Film, Tv, ChevronDown, Monitor } from 'lucide-react';
      ...
      try {
        ...
        if (type === 'tv') {
          const [data, recs] = await Promise.all([
            ...
            getTVRecommendations(numericId).catch(() => ({ page: 1, results: [], total_pages: 0, total_results: 0 })),
          ]);
          setItem(data);
          ...
          const [data, recs] = await Promise.all([
            ...
            getMovieRecommendations(numericId).catch(() => ({ page: 1, results: [], total_pages: 0, total_results: 0 })),
          ]);
          setItem(data);
          setSimilar(recs.results?.slice(0, 6) || []);
        }
